...
trainingFile = input("Input relative location of training file name:\n")

testingFile = input("Input relative location of testing file name:\n")
outputFile = input("Input desired relative location of output file")
print("Training\n")
...
wordFreq = np.zeros([len(categories),len(wordBank)]) + 0.2
